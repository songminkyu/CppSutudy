...
namespace SA {
	...
	public:
		using iterator = typename std::list<typename delegate_base<RET(PARAMS...)>::InvocationElement*>::iterator;
		using const_iterator = typename std::list<typename delegate_base<RET(PARAMS...)>::InvocationElement*>::const_iterator;
		...
		iterator begin() { return invocationList.begin(); }
		iterator end()   { return invocationList.end(); }	
		const_iterator begin() const { return invocationList.begin(); }	
		const_iterator end()   const { return invocationList.end(); }
